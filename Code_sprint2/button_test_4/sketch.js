...
let s = function (sketch) {
    ...
    sketch.mouseClicked = function () {
        ...
        if (canvasEl.style.zIndex !== '9998') {
            ...
            //window.open("http://127.0.0.1:5500/test.html", '_blank'); i tried to link it a page i made but isn't technically online 
            window.open('https://www.nationalgeographic.com/health/article/touch-grass-mental-health-outdoors', 'blank');
            });
